...
1. Teacher uploads material to Azure Blob Storage
2. Text is extracted and converted into embeddings
3. Embeddings are stored in Pinecone vector database
4. Student asks a question which is embedded
5. Relevant context is retrieved from vector database
6. Context is sent to LLM for response generation
